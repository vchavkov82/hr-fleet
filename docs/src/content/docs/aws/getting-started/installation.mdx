...
{/* Define version constant for template */}
...
<LinkButton href={`https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-linux-amd64-onefile.tar.gz`} icon="download" variant="minimal">x86-64</LinkButton>
<LinkButton href={`https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-linux-arm64-onefile.tar.gz`} icon="download" variant="minimal">ARM64</LinkButton>

or use the curl commands below:

For x86-64:

<Code code={`curl --output localstack-cli-3.0.0-linux-amd64-onefile.tar.gz \\\n    --location https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-linux-amd64-onefile.tar.gz`} lang="bash" />

For ARM64:

<Code code={`curl --output localstack-cli-3.0.0-linux-arm64-onefile.tar.gz \\\n    --location https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-linux-arm64-onefile.tar.gz`} lang="bash" />

Then extract the LocalStack CLI from the terminal:

<Code code={`sudo tar xvzf localstack-cli-3.0.0-linux-*-onefile.tar.gz -C /usr/local/bin`} lang="bash" />
...
<LinkButton href={`https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-darwin-amd64-onefile.tar.gz`} icon="download" variant="minimal">Intel (AMD64)</LinkButton>

or use the following curl command:

<Code code={`curl --output localstack-cli-3.0.0-darwin-amd64-onefile.tar.gz \n    --location https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-darwin-amd64-onefile.tar.gz`} lang="bash" />

Then extract the LocalStack CLI from the terminal:

<Code code={`sudo tar xvzf localstack-cli-3.0.0-darwin-*-onefile.tar.gz -C /usr/local/bin`} lang="bash" />
...
<LinkButton href={`https://github.com/localstack/localstack-cli/releases/download/v3.0.0/localstack-cli-3.0.0-windows-amd64-onefile.zip`} icon="download" variant="minimal">Intel (AMD64)</LinkButton>
