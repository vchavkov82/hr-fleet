---
name: ai-seo
description: When the user wants to optimize content for AI search engines, get cited by LLMs, or improve visibility in AI Overviews, ChatGPT, Perplexity, Claude, Gemini, and Copilot
metadata:
  version: 1.0.0
---
...
For a deep dive on how each platform selects sources, see [references/platform-ranking-factors.md](references/platform-ranking-factors.md).

### Key Difference from Traditional SEO

Traditional SEO gets you ranked. AI SEO gets you **cited**.

In traditional search, you need to rank on page 1. In AI search, a well-structured page can get cited even if it ranks on page 2 or 3.
...
For detailed templates, see [references/content-patterns.md](references/content-patterns.md).
...
- Cite original research, not summaries
...
- **Ignoring third-party presence** - Wikipedia mentions may get more AI citations than your own blog
