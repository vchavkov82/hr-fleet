...
type SkillOdooClient interface {
	...
	CreateEmployeeSkill(ctx context.Context, employeeID, skillID, skillLevelID int64) (int64, error)
	ListSkills(ctx context.Context, domain []any, limit, offset int) ([]odoo.Skill, int, error)
...
func (s *SkillService) ListEmployeeSkills(ctx context.Context, employeeID int64, limit, offset int) ([]odoo.EmployeeSkill, int, error) {
	skills, total, err := s.odoo.ListEmployeeSkills(ctx, employeeID, limit, offset)
	if err != nil {
...
func (s *SkillService) AddEmployeeSkill(ctx context.Context, employeeID, skillID, skillLevelID int64) (int64, error) {
	id, err := s.odoo.CreateEmployeeSkill(ctx, employeeID, skillID, skillLevelID)
	if err != nil {
...
func (s *SkillService) DeleteEmployeeSkill(ctx context.Context, id int64) error {
	if err := s.odoo.DeleteEmployeeSkill(ctx, id); err != nil {
...
func (s *SkillService) ListSkills(ctx context.Context, limit, offset int) ([]odoo.Skill, int, error) {
	skills, total, err := s.odoo.ListSkills(ctx, nil, limit, offset)
	if err != nil {
